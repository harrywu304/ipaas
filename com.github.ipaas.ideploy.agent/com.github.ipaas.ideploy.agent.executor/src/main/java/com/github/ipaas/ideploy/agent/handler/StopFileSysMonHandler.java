 ...
 *
 */
public class StopFileSysMonHandler  extends CrsCmdHandlerWithFeed{

	private static Logger logger = LoggerFactory.getLogger(StopFileSysMonHandler.class);
	...
	public void execute(String flowId, String cmd, Map<String, Object> params,BundleContext  bundleContext)
		...
		try{
			...
			fileSysMonitorManager.stopMonitor(servGroup);
		}catch(Exception e){
			logger.error("停止异动异动监控功能出错", e);
		} 
	}
