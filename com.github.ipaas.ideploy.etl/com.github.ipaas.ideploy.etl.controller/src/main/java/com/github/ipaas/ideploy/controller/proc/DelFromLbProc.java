...
public class DelFromLbProc extends ProcWithLog {

	private static Logger logger = LoggerFactory.getLogger(DelFromLbProc.class);
	...
	public void executeWithLog() throws Exception {
		...
		Thread.sleep(3000);
		logger.debug("成功将服务剔出负载均衡" + JsonUtil.toJson(procInput));
	}
}
